...
add_shortcode( 'react-init', 'pif' );
  ...
  function include_react_files() {
    wp_enqueue_style( 'prefix-style', plugins_url('css/main.6d65232d.css', __FILE__) );
    wp_enqueue_script( 'plugin-scripts', plugins_url('js/main.8e2dacb6.js', __FILE__),array(),  '0.0.2', true );
  }
